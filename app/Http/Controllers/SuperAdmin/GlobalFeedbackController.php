...
class GlobalFeedbackController extends Controller
{
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            // Sentiment thật từ phân tích nội dung (lexicon tiếng Việt), khác với positive/negative
            // ở trên vốn chỉ suy ra từ số sao — 2 khách có thể cho 3 sao nhưng 1 người viết tệ, 1 người không để lại gì.
