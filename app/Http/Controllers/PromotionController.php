        ...
        if ($suspicious) {
            if (!$user->can('approve_requests')) {
                return response()->json([
                    ...
                    'message' => 'Cảnh báo gian lận AI: Phát hiện tần suất áp dụng voucher bất thường. Yêu cầu quản lý có quyền phê duyệt để tiếp tục.'
                ], 422);
            }

            // Log manager override of fraud detection
