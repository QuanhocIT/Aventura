...
use App\Http\Requests\CustomTwoFactorLoginRequest;
...
{
    use GeneratesSignedCaptcha;

    public function register(): void
    {
        $this->app->bind(TwoFactorLoginRequest::class, CustomTwoFactorLoginRequest::class);
    }
    ...
    public function boot(): void
    {
        ...
        Fortify::authenticateUsing(function (Request $request) {
            ...
            $failedAttempts = Cache::get("waf:failed_attempts:{$ip}", []);
