...
class CentralWarehouseSupplyChainService
{
    ...
    public function syncSupplierOptions(int $restaurantId, int $ingredientId, array $options): Collection
    {
        ...
        $validSupplierIds = \App\Models\Supplier::where('restaurant_id', $restaurantId)
            ->where('status', 'active')
        ...
        return DB::transaction(function () use ($restaurantId, $ingredient, $options, $supplierIds): Collection {
