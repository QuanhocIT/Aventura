...
class FraudDetectionService
{
    ...
    public function detectAiFraudAlerts(int $restaurantId, string $periodStart, string $periodEnd): array
    {
        ...
        $breakerAvailable = app(\App\Services\CircuitBreaker::class)->for('analytics_service')->isAvailable();
        if ($breakerAvailable && !\Illuminate\Support\Facades\Cache::has($lockKey)) {
