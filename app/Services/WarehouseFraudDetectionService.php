...
class WarehouseFraudDetectionService
{
    ...
    public function analyzeRiskAndFraudPatterns(int $restaurantId): array
    {
        ...
        $cases = WarehouseFraudCase::where('restaurant_id', $restaurantId)
    ...
    protected function syncFraudCases(int $restaurantId, array $alerts): void
    {
        foreach ($alerts as $alert) {
            ...
            WarehouseFraudCase::firstOrCreate(
                [
     ...
     */
    public function assignCase(WarehouseFraudCase $case, User $assignee, ?Carbon $deadline = null): WarehouseFraudCase
    {
        $case->update([
            'assigned_to' => $assignee->id,
            'status' => WarehouseFraudCase::STATUS_INVESTIGATING,
    ...
    public function updateCaseStatus(
        ...
        if (in_array($status, [WarehouseFraudCase::STATUS_RESOLVED, WarehouseFraudCase::STATUS_CLOSED])) {
