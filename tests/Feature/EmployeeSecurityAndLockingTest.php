...
class EmployeeSecurityAndLockingTest extends TestCase
{
    ...
    public function test_stricter_employee_creation_requires_deep_profile_and_id_photos(): void
    {
        ...
        // Check storage link
        Storage::disk('public')->assertExists(str_replace('/storage/', '', $employee->citizen_id_front_url));
        Storage::disk('public')->assertExists(str_replace('/storage/', '', $employee->citizen_id_back_url));
    }
