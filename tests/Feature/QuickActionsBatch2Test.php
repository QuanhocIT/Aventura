...
class QuickActionsBatch2Test extends TestCase
{
    ...
    {
        // Phân công tự động chỉ chạy trong phạm vi Kho Tổng và chỉ giao việc
        // cho nhân sự có vai trò warehouse_staff — chủ quán không nhận việc kho.
        $centralBranch = RestaurantBranch::create([
            'restaurant_id' => $this->restaurant->id,
            'name' => 'Kho Tổng Batch 2',
            'code' => 'KTB2',
            'status' => 'active',
        ...
        $task1->refresh();
        $this->assertEquals($warehouseStaff->id, $task1->assigned_to);
