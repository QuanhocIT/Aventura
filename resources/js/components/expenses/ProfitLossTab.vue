...
const lines = computed(() => [
    ...
    {
        label: 'Giá vốn hàng bán (COGS / Nguyên vật liệu)*',
        value: -cur.value.cogs,
        kind: 'minus',
    },
    {
        label: 'LỢI NHUẬN GỘP',
    ...
    {
        label: 'Chi phí nhân sự (Labor Cost / Lương cứng + Ca trực)*',
        value: -cur.value.labor_cost,
        kind: 'minus',
    },
    {
        label: 'Chi phí vận hành định kỳ & phát sinh (OPEX)',
