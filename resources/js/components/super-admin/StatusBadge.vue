...
const colorMap: Record<string, string> = {
    ...
    processed:
        'bg-emerald-100/80 text-emerald-800 border-emerald-200/50 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-800/40',
    resolved:
        'bg-emerald-100/80 text-emerald-800 border-emerald-200/50 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-800/40',
    published:
        'bg-emerald-100/80 text-emerald-800 border-emerald-200/50 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-800/40',
    ...
    created:
        'bg-sky-100/80 text-sky-800 border-sky-200/50 dark:bg-sky-950/40 dark:text-sky-300 dark:border-sky-800/40',
    ...
    suspended:
        'bg-amber-100/80 text-amber-800 border-amber-200/50 dark:bg-amber-950/40 dark:text-amber-300 dark:border-amber-800/40',
    pending:
        'bg-amber-100/80 text-amber-800 border-amber-200/50 dark:bg-amber-950/40 dark:text-amber-300 dark:border-amber-800/40',
    warning:
        'bg-amber-100/80 text-amber-800 border-amber-200/50 dark:bg-amber-950/40 dark:text-amber-300 dark:border-amber-800/40',
    ...
    expired:
        'bg-rose-100/80 text-rose-800 border-rose-200/50 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-800/40',
    ...
    inactive:
        'bg-slate-100/80 text-slate-700 border-slate-200/50 dark:bg-slate-800/40 dark:text-slate-300 dark:border-slate-700/40',
    cancelled:
        'bg-slate-100/80 text-slate-700 border-slate-200/50 dark:bg-slate-800/40 dark:text-slate-300 dark:border-slate-700/40',
    updated:
        'bg-indigo-100/80 text-indigo-800 border-indigo-200/50 dark:bg-indigo-950/40 dark:text-indigo-300 dark:border-indigo-800/40',
    ...
    maintenance:
        'bg-violet-100/80 text-violet-800 border-violet-200/50 dark:bg-violet-950/40 dark:text-violet-300 dark:border-violet-800/40',
};
...
const badgeClass = computed(() => colorMap[props.status] ?? fallback);

const dotClass = computed(() => dotColorMap[props.status] ?? fallbackDot);
</script>
        ...
        <span
            ...
            :class="
                cn(
                    ...
                    dotClass,
                    ['active', 'up', 'healthy', 'online', 'processed'].includes(
                        status,
                    ) && 'animate-pulse',
                )
            "
