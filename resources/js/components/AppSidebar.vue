...
const superAdminNav = computed<NavItem[]>(() => {
    const all: (NavItem & { perm?: string })[] = [
        { title: 'Tổng quan', href: superAdminDashboard().url, icon: LayoutGrid, perm: 'superadmin.dashboard.view', prefetch: true },
        { title: 'Sức khỏe nhà hàng & chi nhánh', href: '/super-admin/tenant-health', icon: Activity, perm: 'superadmin.tenant.view' },
        ...
        { title: 'Phản hồi', href: '/super-admin/feedback', icon: MessageSquare, perm: 'superadmin.tenant.view' },
        { title: 'Dự đoán rời bỏ', href: '/super-admin/churn-prediction', icon: ShieldAlert, perm: 'superadmin.tenant.view' },
        { title: 'Banner & trình chiếu', href: '/super-admin/banners', icon: Image, perm: 'superadmin.content.manage' },
        { title: 'Tin tức', href: '/super-admin/news', icon: Newspaper, perm: 'superadmin.content.manage' },
        { title: 'Trung tâm thanh toán', href: '/super-admin/billing', icon: BadgeDollarSign, perm: 'superadmin.billing.view' },
        ...
        { title: 'Chiến dịch thanh toán', href: '/super-admin/campaign-templates', icon: Gift, perm: 'superadmin.billing.view' },
        { title: 'Hoa hồng & Rút tiền', href: '/super-admin/referrals', icon: Crown, perm: 'superadmin.billing.view' },
        { title: 'Hỗ trợ kỹ thuật', href: '/super-admin/support', icon: Headset, perm: 'superadmin.support.manage' },
        { title: 'Trợ lý AI', href: '/super-admin/chatbot', icon: Bot, perm: 'superadmin.support.manage' },
        { title: 'Chẩn đoán trợ lý AI', href: '/super-admin/chatbot-diagnostics', icon: Brain, perm: 'superadmin.support.manage' },
        { title: 'Chiến dịch thông báo', href: '/super-admin/campaigns', icon: Megaphone, perm: 'superadmin.support.manage' },
        { title: 'Tài khoản nền tảng', href: '/super-admin/accounts', icon: Users, perm: 'superadmin.system.manage' },
        { title: 'Nhật ký hệ thống', href: '/super-admin/audit-logs', icon: FileSearch2, perm: 'superadmin.audit.view' },
        ...
        { title: 'Trung tâm vận hành', href: '/super-admin/operations', icon: ServerCog, perm: 'superadmin.system.manage' },
        { title: 'Lịch bảo trì hệ thống', href: '/super-admin/maintenance-schedules', icon: CalendarDays, perm: 'superadmin.system.manage' },
        { title: 'Sao lưu & tối ưu cơ sở dữ liệu', href: '/super-admin/backup-maintenance', icon: Database, perm: 'superadmin.backup.manage' },
        { title: 'Dọn dẹp rác', href: '/super-admin/garbage-collector', icon: Trash2, perm: 'superadmin.system.manage' },
        { title: 'Bảng điều khiển tìm kiếm', href: '/super-admin/meilisearch-console', icon: Database, perm: 'superadmin.system.manage' },
