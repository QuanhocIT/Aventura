...
<template>
    <button
        ...
        :class="[
            'group relative w-full overflow-hidden rounded-2xl border text-left backdrop-blur-md transition-all duration-300',
        ...
        <template v-else>
            ...
            <ul class="space-y-2">
                ...
                >
                    ...
                    <span
                        class="text-[11px] leading-snug text-zinc-600 line-through decoration-zinc-800/80"
                        >{{ f }}</span
                    >
                </li>
            </ul>
