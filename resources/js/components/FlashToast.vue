        ...
        <div class="fixed bottom-5 right-5 z-[9999] flex flex-col gap-2.5 pointer-events-none" style="max-width: 360px;">
            ...
            >
                <div
                    ...
                    :class="{
                        'bg-emerald-50 border-emerald-200 dark:bg-emerald-950/80 dark:border-emerald-800': toast.type === 'success',
                        'bg-red-50 border-red-200 dark:bg-red-950/80 dark:border-red-800': toast.type === 'error',
                        'bg-blue-50 border-blue-200 dark:bg-blue-950/80 dark:border-blue-800': toast.type === 'info',
                    }"
                >
                    <CheckCircle2
                        v-if="toast.type === 'success'"
                        class="size-5 shrink-0 mt-0.5 text-emerald-600 dark:text-emerald-400"
                    />
                    <XCircle
                        v-else-if="toast.type === 'error'"
                        class="size-5 shrink-0 mt-0.5 text-red-600 dark:text-red-400"
                    />
                    <Info
                        v-else
                        class="size-5 shrink-0 mt-0.5 text-blue-600 dark:text-blue-400"
                    />
