            ...
            <div class="space-y-1.5">
                ...
                <div class="flex items-center justify-between text-xs">
                    ...
                    <span
                        class="font-semibold"
                        :class="
                            tenant?.plan?.features?.ai_features
                                ? 'text-emerald-500'
        ...
        <Teleport to="body">
            ...
            >
                ...
                >
                    ...
                    <!-- Header -->
                    <div
                        class="border-b border-border px-6 pt-8 pb-5 text-center"
                    >
                        <div
                    ...
                    >
                        <span class="flex items-center gap-1.5">
                            <Lock class="size-3.5" />
                            Giao dịch được mã hóa an toàn · Không mất dữ liệu
                            khi nâng gói
                        </span>
                        <Button
                            variant="outline"
