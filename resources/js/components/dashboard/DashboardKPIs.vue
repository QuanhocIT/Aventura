    ...
    <div class="space-y-5">
        ...
        >
            ...
            <div class="w-full flex-1">
                ...
                <div
                    class="h-2 overflow-hidden rounded-full bg-slate-200/50 dark:bg-black/30"
                >
                    <div
                        :class="[
                ...
                <div
                    class="mt-2 flex flex-wrap gap-x-5 gap-y-1 text-[11px] font-semibold text-slate-500 dark:text-slate-400"
                >
