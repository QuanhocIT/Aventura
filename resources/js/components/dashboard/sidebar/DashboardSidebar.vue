...
const onboardingSteps = computed(() => {
    ...
    return [
        ...
        {
            key: 'day_4',
            label: 'Thêm nhân viên & phân quyền',
            href: '/employees',
            done: !!status.day_4?.completed_at,
        },
        {
            key: 'day_5',
            label: 'Cấu hình thanh toán & gói',
            href: '/billing/history',
            done: !!status.day_5?.completed_at,
        },
    ];
});
                        ...
                        >
                            ...
                            <div class="flex shrink-0 flex-col items-end gap-1">
                                <span
                                    ...
                                    :class="
                                        orderStatusMap[order.status]?.class ??
                                ...
                                <span class="text-xs font-semibold">{{
                                    formatMoneyFull(order.total_amount)
                                }}</span>
                            </div>
                        </Link>
                    </div>
                ...
                <CardContent class="space-y-4 pt-4 pb-4">
                    ...
                    >
                        ...
                        <span
                            ...
                            :class="pendingCount > 5 ? 'text-amber-600' : ''"
                        >
                            {{ pendingCount }}
                        </span>
                    </div>
