    ...
    >
        <template #fallback>
            <div class="space-y-6">
                ...
                >
                    <div
                        class="h-6 w-48 animate-pulse rounded-lg bg-slate-100 dark:bg-slate-800"
                    />
                    <div
                        class="h-10 w-64 animate-pulse rounded-lg bg-slate-100 dark:bg-slate-800"
                    />
                </div>
                <!-- Main skeleton card -->
                <div
                    class="flex h-[400px] w-full animate-pulse items-center justify-center rounded-2xl border border-slate-100 bg-slate-50/50 dark:border-slate-800 dark:bg-slate-900/10"
                >
                    <div class="flex flex-col items-center gap-2">
                        <Activity
                            class="text-slate-350 dark:text-slate-650 size-6 animate-pulse"
                        />
                        <span
                            class="text-xs font-bold tracking-tight text-slate-400"
                            >Đang tải trung tâm vận hành...</span
                        >
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            >
                ...
                >
                    <Crown
                        class="mb-2.5 size-8 animate-pulse text-amber-400/30"
                    />
