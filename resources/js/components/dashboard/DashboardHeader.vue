...
const planBadgeClass = computed(() => {
    switch (props.plan?.code) {
        case 'pro':   return 'bg-gradient-to-r from-primary to-amber-500 hover:from-primary/90 hover:to-amber-400 text-white shadow-sm border-0';
...
<template>
    <div class="relative overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-primary/5 via-violet-500/3 to-rose-500/2 dark:from-primary/10 dark:via-violet-500/5 dark:to-rose-500/3 pointer-events-none" />
        <div class="absolute -top-40 -left-40 size-96 bg-primary/10 dark:bg-primary/20 rounded-full blur-[120px] pointer-events-none float-glow" />
        <div class="absolute -top-32 -right-32 size-80 bg-violet-500/8 dark:bg-violet-500/15 rounded-full blur-[100px] pointer-events-none float-glow" style="animation-delay: 4s;" />
        <div class="absolute top-20 left-1/2 size-60 bg-rose-500/5 dark:bg-rose-500/10 rounded-full blur-[80px] pointer-events-none float-glow" style="animation-delay: 6s;" />
