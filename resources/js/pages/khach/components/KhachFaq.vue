        ...
        <div class="mx-auto max-w-7xl">
            <div class="reveal-on-scroll flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-end">
                <div class="max-w-xl">
                    ...
                    <h2 class="text-3xl font-semibold heading-section text-gradient-brand">Câu hỏi thường gặp</h2>
                ...
                <div v-for="(item, i) in faq" :key="item.q">
                    ...
                    >
                        ...
                        <ChevronRight
                            ...
                            :class="openFaqIndex === i ? 'rotate-90 text-primary' : 'text-muted-foreground'"
                        />
                    </button>
