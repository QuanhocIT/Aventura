...
const cases = [
    {
        ...
        problem:
            'Quản lý bằng Excel, sai số liệu thường xuyên, không biết món nào đang lỗ',
    ...
    },
    {
        ...
        problem:
            'Bếp bị quá tải giờ cao điểm, table turn thấp, nhân viên tự ý huỷ order',
...
function next() {
    activeCase.value = (activeCase.value + 1) % cases.length;
}
function prev() {
    activeCase.value = (activeCase.value - 1 + cases.length) % cases.length;
}
</script>
...
<template>
    <section
        id="case-study"
        class="relative overflow-hidden bg-muted/30 py-20 lg:py-28"
    >
        <div class="pointer-events-none absolute inset-0 overflow-hidden">
            <div
                class="absolute top-1/2 left-1/2 h-[400px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/5 blur-3xl"
            />
        </div>
        ...
        <div class="relative mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <div class="reveal-on-scroll mb-12 text-center">
                <span
                    class="mb-4 inline-block rounded-full border border-green-500/30 bg-green-500/10 px-4 py-1.5 text-xs font-semibold tracking-widest text-green-600 uppercase dark:text-green-400"
                >
                    Case Study
                </span>
                <h2 class="text-3xl font-bold text-foreground sm:text-4xl">
                    Kết quả thực tế từ
                    <span class="text-primary">khách hàng</span>
                </h2>
                <p class="mx-auto mt-3 max-w-xl text-muted-foreground">
                    Không phải số liệu demo — đây là dữ liệu thật từ nhà hàng
                    đang dùng Aventura.
                </p>
            </div>
            ...
            <div class="reveal-on-scroll">
                    ...
                    >
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 text-2xl font-black text-primary shadow-sm"
                                >
                                ...
                                <div>
                                    ...
                                    >
                                        {{ cases[activeCase].restaurant }}
                                    </h3>
                                    <p class="text-sm text-muted-foreground">
                                        {{ cases[activeCase].type }}
                                    </p>
                                    <div class="mt-1 flex items-center gap-0.5">
                                        <Star
                                            v-for="i in cases[activeCase]
                                                .rating"
                                            :key="i"
                            ...
                            <!-- Quote -->
                            <div
                                class="relative rounded-2xl border border-border bg-card p-6 shadow-sm"
                            >
                                <Quote
                                    class="absolute top-4 left-4 h-6 w-6 text-primary/20"
                                />
                                <p
                                    class="relative pl-2 text-sm leading-relaxed text-muted-foreground italic"
                                >
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                >
                                    <p
                                        class="mb-2 text-xs font-bold tracking-wider text-destructive uppercase"
                                    >
                                        ❌ Trước
                                    </p>
                                    <p
                                ...
                                >
                                    <p
                                        class="mb-2 text-xs font-bold tracking-wider text-green-600 uppercase dark:text-green-400"
                                    >
                                        ✅ Sau
                                    </p>
                                    <p
                ...
                <div class="mt-10 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <button
                            @click="prev"
                            class="flex h-10 w-10 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-all hover:bg-muted hover:text-foreground"
                        >
                            <ChevronLeft class="h-4 w-4" />
                        </button>
                        <button
                            @click="next"
                            class="flex h-10 w-10 items-center justify-center rounded-full border border-primary/30 bg-primary/10 text-primary transition-all hover:bg-primary/20"
                        >
