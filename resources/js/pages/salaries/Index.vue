...
function exportCSV() {
    const rows = [
        ['Nhân viên', 'Chức vụ', 'Loại HĐ', 'Lương cơ bản', 'Thưởng', 'Khấu trừ', 'Lương thực lãnh', 'Trạng thái'],
        ...props.salaries.map(s => [
            s.employee_name, s.job_title, s.employment_type,
            s.base_salary, s.bonus_amount, s.deduction_amount, s.net_salary,
    ...
    a.download = `bangluong_${activePeriod.value}.csv`; a.click();
