            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Giám sát hạ tầng · Ticket hỗ trợ · Broadcast realtime ·
                        Knowledge base
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-5">
            <Card class="border-0 bg-gradient-to-br from-sky-50 to-sky-100/60">
                <CardContent class="flex items-center justify-between p-4">
                    ...
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-sky-200/60"
                    >
            ...
            <Card class="border-0 bg-gradient-to-br from-red-50 to-red-100/60">
                <CardContent class="flex items-center justify-between p-4">
                    ...
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-red-200/60"
                    >
            ...
            <Card
                class="border-0 bg-gradient-to-br from-amber-50 to-amber-100/60"
            >
                <CardContent class="flex items-center justify-between p-4">
                    <div>
                    ...
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-200/60"
                    >
            ...
            <Card
                class="border-0 bg-gradient-to-br from-violet-50 to-violet-100/60"
            >
                <CardContent class="flex items-center justify-between p-4">
                    <div>
                    ...
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-200/60"
                    >
            ...
            <Card
                class="border-0 bg-gradient-to-br from-emerald-50 to-emerald-100/60"
            >
                <CardContent class="flex items-center justify-between p-4">
                    <div>
                    ...
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-200/60"
                    >
                    ...
                    <Card>
                        <CardContent class="p-5">
                            ...
                            <p class="mt-3 text-2xl font-bold">
                                {{ monitoring.infra.cpu ?? 'N/A' }} /
                                {{ monitoring.infra.ram ?? 'N/A' }}
                            </p>
                            <p class="mt-1 text-xs text-muted-foreground">
                                {{ monitoring.infra.source }}
                            </p>
                        </CardContent>
                    </Card>
                    <Card class="border-dashed bg-muted/20">
                        <CardContent
                            class="flex h-full flex-col items-center justify-center p-5 text-center"
                        >
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <CardTitle class="text-base"
                                    >Cảnh báo gần đây</CardTitle
                                >
                                <CardDescription
                                    >Các alert được kích hoạt bởi rule
                                    engine</CardDescription
                                >
                            </div>
                            <Button
                                variant="outline"
                ...
                <div class="grid gap-6 xl:grid-cols-5">
                    ...
                    <Card class="xl:col-span-2">
                        <CardHeader>
                            ...
                            >
                                <PlusCircle class="size-4 text-sky-500" /> Tạo
                                Ticket Hỗ Trợ
                            </CardTitle>
                            <CardDescription
                                >Tiếp nhận sự cố, báo cáo lỗi từ nhà
                            ...
                            >
                                    ...
                                    <Select v-model="ticketForm.category">
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="billing"
                                                >Billing / Hoá đơn</SelectItem
                                            >
                                            <SelectItem value="ui"
                                                >UI / Nội dung</SelectItem
                                            >
                                            <SelectItem value="performance"
                                                >Hiệu năng</SelectItem
                                            >
                                ...
                                <div class="grid gap-1.5">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Màn hình bếp không nhận realtime"
                                    />
                                    <p
                                ...
                                <div class="grid gap-1.5">
                                    ...
                                    <textarea
                                        ...
                                        class="min-h-24 w-full rounded-md border bg-background px-3 py-2 text-sm focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                                    />
                                    <p
                                ...
                                <p class="text-xs text-muted-foreground">
                                    Hệ thống sẽ tự động phân loại mức độ:
                                    <strong
                    ...
                    <div class="xl:col-span-3">
                        <Card class="h-full">
                            <CardHeader class="pb-3">
                                ...
                                >
                                <CardDescription
                                    >12 ticket gần nhất · tự động phân loại theo
                                    mức độ nghiêm trọng</CardDescription
                                >
                            </CardHeader>
                            <CardContent>
                ...
                <div class="grid gap-6 xl:grid-cols-5">
                    ...
                    <Card class="xl:col-span-2">
                        <CardHeader>
                            <CardTitle
                                class="flex items-center gap-2 text-base"
                            >
                                <BellRing class="size-4 text-violet-500" /> Tạo
                                Thông Báo Broadcast
                            </CardTitle>
                            <CardDescription
                                >Popup realtime qua Laravel Reverb · Gửi đến Thu
                                ngân, Chủ quán, Bếp</CardDescription
                            >
                        </CardHeader>
                        <CardContent>
                            <form
                            ...
                            >
                                <div class="grid gap-1.5">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Bảo trì hệ thống 23:00-24:00"
                                    />
                                </div>
                                <div class="grid gap-1.5">
                                ...
                                <div
                                    class="flex items-center gap-2 rounded-lg border border-violet-200 bg-violet-50 p-3"
                                >
                                    <input
                                        id="publish_now"
                                        v-model="announcementForm.publish_now"
                                        type="checkbox"
                                        class="size-4 rounded border-violet-300 accent-violet-600"
                                    />
                                    <label
                                        for="publish_now"
                                        class="text-sm font-medium text-violet-800"
                                        >Phát ngay lập tức (Reverb
                                        broadcast)</label
                                    >
                                </div>
                                <Button
                    ...
                    <div class="xl:col-span-3">
                        <Card class="h-full">
                            <CardHeader class="pb-3">
                                <CardTitle class="text-base"
                                    >Lịch sử thông báo</CardTitle
                                >
                                <CardDescription
                                    >6 thông báo gần nhất</CardDescription
                                >
                            </CardHeader>
                            <CardContent>
                                <div
                                ...
                                >
                                    ...
                                    <p class="text-xs">
                                        Tạo thông báo để broadcast đến tất cả
                                        màn hình
                                    </p>
                                </div>
                            </CardContent>
                    ...
                    <Card class="xl:col-span-2">
                        <CardHeader>
                            <CardTitle
                                class="flex items-center gap-2 text-base"
                            >
                                <Siren class="size-4 text-amber-500" /> Tạo
                                Alert Rule
                            </CardTitle>
                            <CardDescription
                                >Hệ thống tự gửi cảnh báo qua Telegram/Discord
                                khi vượt ngưỡng</CardDescription
                            >
                        </CardHeader>
                        <CardContent>
                            <form
                        ...
                        <Card class="h-full">
                            <CardHeader class="pb-3">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        >
                                        <CardDescription
                                            >Rules kích hoạt gửi cảnh báo tự
                                            động</CardDescription
                                        >
                                    </div>
                                    <Button
                                        variant="outline"
                            ...
                            <CardContent>
                                ...
                                >
                                    ...
                                    <p class="text-xs">
                                        Tạo rule để hệ thống tự cảnh báo khi
                                        vượt ngưỡng
                                    </p>
                                </div>
                            </CardContent>
                    ...
                    <Card class="xl:col-span-2">
                        <CardHeader>
                            <CardTitle
                                class="flex items-center gap-2 text-base"
                            >
                                <BookOpenText class="size-4 text-emerald-500" />
                                Thêm Bài Viết
                            </CardTitle>
                            <CardDescription
                                >Tài liệu hướng dẫn tự phục vụ cho nhà
                                hàng</CardDescription
                            >
                        </CardHeader>
                        <CardContent>
                            ...
                            >
                                ...
                                <div class="grid gap-1.5">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Hướng dẫn cấu hình màn hình bếp"
                                    />
                                </div>
                                <div class="grid gap-1.5">
                                    <Label>Tóm tắt</Label>
                                ...
                                <div
                                    class="flex items-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 p-3"
                                >
                                    <input
                                        id="is_published"
                                        v-model="articleForm.is_published"
                                        type="checkbox"
                                        class="size-4 rounded border-emerald-300 accent-emerald-600"
                                    />
                                    <label
                                        for="is_published"
                                        class="text-sm font-medium text-emerald-800"
                                        >Xuất bản ngay cho nhà hàng xem</label
                                    >
                                </div>
                                <Button
                                    type="submit"
                    ...
                    <div class="xl:col-span-3">
                        <Card class="h-full">
                            <CardHeader class="pb-3">
                                ...
                                >
                                <CardDescription
                                    >Self-service knowledge base · Nhà hàng tự
                                    tra cứu và giải quyết sự cố</CardDescription
                                >
                            </CardHeader>
                            <CardContent>
                                ...
                                >
                                    ...
                                    <p class="text-xs">
                                        Thêm tài liệu hướng dẫn để nhà hàng tự
                                        tra cứu
                                    </p>
                                </div>
                            </CardContent>
