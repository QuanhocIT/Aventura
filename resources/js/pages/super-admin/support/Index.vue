                    ...
                    <CardContent class="p-6">
                        ...
                        >
                            <span class="text-xs font-semibold text-slate-500"
                                >Trang {{ alerts.current_page }}/{{
                                    alerts.last_page
                                }}
                                ({{ alerts.total }} cảnh báo)</span
                            >
                            <div class="flex items-center gap-1">
                                <button
                                    ...
                                    :key="link.label"
                                    :disabled="!link.url"
                                    class="rounded-lg px-2.5 py-1 text-xs font-bold transition disabled:opacity-40"
                                    :class="
                                        link.active
                                ...
                                >
                                    ...
                                    <div class="flex items-center gap-1">
                                        <button
                                            ...
                                            v-html="link.label"
                                            @click="
                                                goToAnnouncementsPage(link.url)
                                            "
                                        />
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            <CardContent class="p-6">
                                ...
                                >
                                    <span
                                        class="text-xs font-semibold text-slate-500"
                                        >Trang {{ rules.current_page }}/{{
                                            rules.last_page
                                        }}
                                        ({{ rules.total }} rules)</span
                                    >
                                    <div class="flex items-center gap-1">
                                        <button
                        ...
                        >
                            ...
                            <CardContent class="p-6">
                                ...
                                >
                                    <span
                                        class="text-xs font-semibold text-slate-500"
                                        >Trang {{ articles.current_page }}/{{
                                            articles.last_page
                                        }}
                                        ({{ articles.total }} bài viết)</span
                                    >
                                    <div class="flex items-center gap-1">
                                        <button
