                    ...
                    <div class="max-h-[70vh] space-y-4.5 overflow-y-auto p-5">
                        ...
                        <div class="grid gap-1.5">
                            <Label
                                ...
                                class="flex items-center gap-1.5 text-xs font-bold tracking-wider text-muted-foreground uppercase"
                            >
                                <Hash class="size-3.5 text-orange-500" /> Tiền
                                tố mã
                                <span class="text-rose-500">*</span>
                            </Label>
                            <Input
                        ...
                        <div class="grid gap-1.5">
                            <Label
                                ...
                                class="flex items-center gap-1.5 text-xs font-bold tracking-wider text-muted-foreground uppercase"
                            >
                                <Layers class="size-3.5 text-orange-500" /> Số
                                lượng mã <span class="text-rose-500">*</span>
                            </Label>
                            <Input
                                id="code_count"
                        ...
                        <div class="grid gap-1.5">
                            <Label
                                ...
                                class="flex items-center gap-1.5 text-xs font-bold tracking-wider text-muted-foreground uppercase"
                            >
                                <Users class="size-3.5 text-orange-500" /> Giới
                                hạn dùng / mã
                            </Label>
                            <Input
