...
<template>
    ...
    <div class="flex flex-col gap-5 px-6 py-5">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <StatCard label="Tổng coupon" :value="stats.total" :icon="Hash" color="sky" class="" />
            <StatCard label="Đang hoạt động" :value="stats.active" :icon="BadgePercent" color="emerald" class="" />
            <StatCard label="Đã hết hạn/tắt" :value="stats.expired" :icon="X" color="rose" class="" />
            <StatCard label="Tổng lần dùng" :value="stats.total_uses" :icon="TrendingUp" color="indigo" class="" />
            <StatCard label="Tổng đã giảm" :value="`${stats.total_saved}₫`" :icon="DollarSign" color="violet" class="" />
        </div>
