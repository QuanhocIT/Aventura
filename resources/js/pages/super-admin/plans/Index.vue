        ...
        <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            >
                ...
                <template v-if="editingId !== plan.id">
                    <Card
                        class="flex h-full flex-col justify-between border-border transition-all duration-200 hover:shadow-md"
                        :class="{
                    ...
                    >
                        ...
                        <!-- Meta footer -->
                        <div class="mt-3 border-t border-border px-6 pt-2 pb-4">
                            <p
                                class="flex items-center justify-between text-xs text-muted-foreground"
                            >
                                <span
                                    >{{ plan.restaurants_count }} nhà hàng đang
                                    dùng</span
                                >
                                <span
                    ...
                    <Card class="border-2 border-primary/40">
                        ...
                        <CardContent class="flex flex-col gap-4">
                            ...
                            >
                                ...
                                >
                                    <span class="text-sm"
                                        >AI dự báo & phát hiện gian lận</span
                                    >
                                    <input
                                        type="checkbox"
                                ...
                                >
                                    <span class="text-sm"
                                        >Phân tích nâng cao & Audit Log</span
                                    >
                                    <input
                                        type="checkbox"
