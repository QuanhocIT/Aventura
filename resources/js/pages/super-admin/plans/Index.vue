                ...
                <CardHeader class="pb-3">
                    <div class="flex items-center justify-between">
                        <CardTitle class="flex items-center gap-2">
                            <Crown v-if="plan.code === 'PRO'" class="size-5 text-purple-500" />
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <Button v-else variant="ghost" size="icon-sm" @click="save(plan.id)" :disabled="form.processing">
                                <Save class="size-4 text-green-600" />
                            </Button>
                        </div>
                    </div>
                    <p :class="['text-lg font-bold', plan.code === 'PRO' ? 'text-purple-600' : 'text-muted-foreground']">
                ...
                <CardContent class="flex flex-col gap-4">
                    ...
                    <template v-if="editingId !== plan.id">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span v-for="feat in ['ai_features', 'realtime', 'advanced_analytics']" :key="feat"
                                :class="['inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-medium',
                                    plan.features?.[feat]
                                        ? 'bg-green-100 text-green-700 dark:bg-green-900/30'
                                        : 'bg-muted text-muted-foreground line-through']">
                                <CheckCircle2 v-if="plan.features?.[feat]" class="size-3" />
