...
<template>
    ...
    <div class="flex flex-col gap-5 px-6 py-5">
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <StatCard label="Tổng bài" :value="stats.total" :icon="Newspaper" color="sky" class="" />
            <StatCard label="Đã đăng" :value="stats.published" :icon="Eye" color="emerald" class="" />
            <StatCard label="Nổi bật" :value="stats.featured" :icon="Star" color="amber" class="" />
            <StatCard label="Lượt xem" :value="stats.total_views" :icon="Eye" color="violet" class="" />
        </div>
