...
<template>
    ...
    <div class="flex flex-col gap-6 p-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Đăng bài, khuyến mãi, câu chuyện thành công
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <Card
                ><CardContent class="pt-4"
                    ><p class="text-xs text-muted-foreground">Tổng bài</p>
            ...
            <Card
                ><CardContent class="pt-4"
                    ><p class="text-xs text-muted-foreground">Đã đăng</p>
            ...
            <Card
                ><CardContent class="pt-4"
                    ><p class="text-xs text-muted-foreground">Nổi bật</p>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <Button variant="ghost" size="sm" class="h-8" @click="applyFilters"
                >Tìm</Button
            >
            <Button
                v-if="hasFilters"
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b bg-muted/40">
                                ...
                                <th
                                    class="w-28 px-4 py-2.5 text-left font-medium text-muted-foreground"
                                >
                                    Danh mục
                                </th>
                                <th
                        ...
                        <tbody>
                            <tr
                                ...
                                :key="post.id"
                                class="border-b transition hover:bg-muted/20"
                            >
                                <!-- Title + thumbnail -->
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p
                                                class="line-clamp-1 leading-snug font-medium"
                                            >
                                                {{ post.title }}
                                            </p>
                                            <p
                    ...
                    <div class="flex gap-1">
                        <template v-for="link in posts.links" :key="link.label">
                            <button
                                ...
                                "
                                class="min-w-8 rounded px-2 py-1 text-xs transition"
                                v-html="link.label"
                            />
                        </template>
                    </div>
    ...
    >
        ...
        >
            <div
                class="mb-10 flex w-full max-w-2xl flex-col gap-5 rounded-2xl bg-background p-6 shadow-2xl"
            >
                <div class="flex items-center justify-between">
                ...
                <form @submit.prevent="submitForm" class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                class="flex size-28 shrink-0 items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-border bg-muted"
                            >
                                <img
                                    v-if="imagePreview"
                                    :src="imagePreview"
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <Label
                                    for="image-upload"
                                    class="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border px-3 py-1.5 text-sm transition hover:bg-muted"
                                >
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <textarea
                            ...
                            rows="8"
                            placeholder="Nội dung bài viết... Hỗ trợ **in đậm** và xuống dòng"
                            class="w-full rounded-md border border-input bg-background px-3 py-2 font-mono text-sm placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                        />
                        <p
                        ...
                        <p class="text-xs text-muted-foreground">
                            Tip: **text** = in đậm, xuống dòng bằng Enter
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <Input
                            v-model="tagsText"
                            placeholder="khuyến mãi, tính năng, cập nhật"
                        />
                    </div>
