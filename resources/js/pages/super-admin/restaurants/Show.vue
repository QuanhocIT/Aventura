        ...
        <div class="grid gap-6 lg:grid-cols-[1.5fr,0.9fr]">
                ...
                <div class="grid gap-6 xl:grid-cols-3">
                    <Card class="xl:col-span-2">
                        <CardHeader class="pb-3">
                            ...
                            >
                                <ReceiptText class="size-4 text-sky-600" /> Hoa
                                don gan day
                            </CardTitle>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader class="pb-3">
                            <CardTitle
                                class="flex items-center gap-2 text-base"
                            >
                                <RefreshCcw class="size-4 text-violet-600" />
                                Webhook log
                            </CardTitle>
                        </CardHeader>
                        <CardContent class="space-y-3">
                    ...
                    <Card>
                        <CardHeader class="pb-3">
                            <CardTitle
                                class="flex items-center gap-2 text-base"
                            >
                                <WalletCards class="size-4 text-emerald-600" />
                                Lich su dieu chinh
                            </CardTitle>
                        </CardHeader>
                        <CardContent class="space-y-3">
            ...
            <div class="flex flex-col gap-6">
                ...
                <Card>
                    <CardHeader class="pb-3">
                        <CardTitle class="text-base"
                            >Lich su subscription</CardTitle
                        >
                    </CardHeader>
                    <CardContent class="space-y-3">
                        <div
