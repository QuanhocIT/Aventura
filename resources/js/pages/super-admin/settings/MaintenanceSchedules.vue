...
<template>
    ...
    <div class="flex flex-col gap-6 p-6">
        <div class="flex items-center gap-4">
            <Button variant="ghost" size="icon-sm" @click="window.history.back()">
                <ArrowLeft class="size-4" />
            </Button>
            <div>
                <h1 class="text-2xl font-bold tracking-tight">Lịch bảo trì hệ thống</h1>
                <p class="text-sm text-muted-foreground">Lên lịch nâng cấp dịch vụ và tự động cảnh báo các tenant</p>
            </div>
        </div>
