...
import {
    ...
    Shield, Activity, FileText, Lock, Globe, Server, CheckCircle2, Send,
...
const doSubmit = () => {
    ...
    form.post('/super-admin/settings', { preserveScroll: true });
};
                    ...
                    <Card v-if="activeTab === 'mail'" class="border border-slate-200/80 shadow-xs">
                        ...
                        <CardContent class="p-6 space-y-6">
                            ...
                            <div v-if="form.mail_driver === 'smtp'" class="space-y-4 border-t pt-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="grid gap-1.5">
                                        ...
                                        <span v-if="settings.has_smtp_password" class="text-xs text-emerald-600 flex items-center gap-1">
                                            <CheckCircle2 class="size-3" /> Đã thiết lập
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="form.mail_driver === 'ses'" class="space-y-4 border-t pt-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="grid gap-1.5">
                                        ...
                                        <span v-if="settings.has_ses_secret" class="text-xs text-emerald-600 flex items-center gap-1">
                                            <CheckCircle2 class="size-3" /> Đã thiết lập
                                        </span>
                                    </div>
                                    <div class="grid gap-1.5">
                            ...
                            <div v-if="form.mail_driver === 'mailgun'" class="space-y-4 border-t pt-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="grid gap-1.5">
                                        ...
                                        <span v-if="settings.has_mailgun_secret" class="text-xs text-emerald-600 flex items-center gap-1">
                                            <CheckCircle2 class="size-3" /> Đã thiết lập
                                        </span>
                                    </div>
                                    <div class="grid gap-1.5">
                            ...
                            <div class="border-t pt-4">
                                ...
                                <p class="text-xs text-slate-400 mt-1.5">Gửi email thử đến địa chỉ email tài khoản đang đăng nhập để xác nhận cấu hình hoạt động.</p>
                            </div>
                        </CardContent>
                    </Card>
        ...
        <DialogContent class="sm:max-w-md">
            <DialogHeader>
                <DialogTitle class="flex items-center gap-2">
                    <Shield class="size-5 text-amber-500" />
            ...
            <DialogFooter class="flex gap-2 sm:justify-end">
                <Button variant="outline" @click="showConfirmDialog = false">Hủy bỏ</Button>
                <Button class="bg-indigo-600 hover:bg-indigo-700 text-white" @click="doSubmit" :disabled="form.processing">
