...
function deleteBanner(banner: Banner) {
    ...
    router.delete(route('superadmin.banners.destroy', banner.id), {
        preserveScroll: true,
    });
}
        ...
        <div class="mx-auto max-w-6xl space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-400">
                    Upload ảnh để thay đổi giao diện trang khách hàng mà không
                    cần đụng code.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-2">
                                <input
                                    ...
                                    type="checkbox"
                                    class="h-4 w-4 rounded border-gray-600 bg-gray-700 text-indigo-500"
                                />
                                <Label
                                    for="is_active"
                ...
                <Card class="border-gray-800 bg-gray-900">
                    <CardHeader>
                        <CardTitle class="text-base text-white">
                            Banner hiện tại
                            <Badge class="ml-2 bg-gray-700 text-gray-300">{{
            ...
            <!-- Preview note -->
            <div
                class="rounded-xl border border-gray-800 bg-gray-900/50 p-4 text-sm text-gray-500"
            >
