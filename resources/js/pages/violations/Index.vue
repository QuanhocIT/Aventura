                    ...
                    >
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <textarea
                                ...
                                rows="4"
                                required
                                class="dark:bg-slate-905 w-full resize-none rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-xs transition-all placeholder:text-slate-400 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 focus:outline-none dark:border-slate-800 dark:placeholder:text-slate-600"
                            ></textarea>
                        </div>
