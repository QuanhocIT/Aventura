        ...
        .catch((err) => {
            toast(
                err.response?.data?.message ||
                    'Có lỗi khi đánh dấu phục vụ món.',
                'error',
            );
        })
        .finally(() => {
    ...
    >
        ...
        <main class="flex-1">
            ...
            >
                ...
                <div
                    class="rounded-3xl border border-indigo-100 bg-white p-6 shadow-sm dark:border-indigo-900/40 dark:bg-slate-900"
                >
                    <div
                        class="mb-4 flex items-center justify-between border-b border-slate-100 pb-4 dark:border-slate-800"
                    >
                        <div class="flex items-center gap-2">
                            <Utensils
                                class="size-5 animate-bounce text-emerald-500"
                            />
                            <div>
                                <h3
                                ...
                                <p class="text-xs text-muted-foreground">
                                    Danh sách món đã nấu xong, chờ nhân viên
                                    bưng lên bàn cho khách
                                </p>
                            </div>
                        </div>
                        <span
                            class="rounded-xl bg-emerald-50 px-3 py-1 font-mono text-xs font-bold text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400"
                        >
                            {{ props.kitchenReadyItems?.length || 0 }} món sẵn
                            sàng
                        </span>
                    </div>
                    ...
                    <div
                        v-if="
                            !props.kitchenReadyItems ||
                            props.kitchenReadyItems.length === 0
                        "
                        ...
                        >
                            <div>
                                <div class="flex items-center justify-between">
                                    <span
                                        class="rounded-lg bg-emerald-500 px-2 py-0.5 text-[10px] font-extrabold text-white"
                                    >
                                        ĐÃ NẤU XONG
                                    </span>
                                    <span
                                ...
                                <div
                                    class="mt-2 text-sm font-black text-slate-900 dark:text-slate-100"
                                >
                                    Bàn {{ item.table_name || 'Mang về' }}
                                </div>

                                <div
                                    class="mt-1 text-xs font-extrabold text-emerald-700 dark:text-emerald-300"
                                >
                                ...
                                <p
                                    v-if="item.notes"
                                    class="mt-1 text-[11px] text-amber-600 italic dark:text-amber-400"
                                >
                                    Ghi chú: {{ item.notes }}
                                </p>
                            ...
                            <Button
                                size="sm"
                                class="mt-3 w-full rounded-xl bg-emerald-600 text-xs font-bold text-white hover:bg-emerald-700"
                ...
                >
                    ...
                    <div
                        v-if="
                            ...
                            props.completedHistory.length === 0
                        "
                        class="py-8 text-center text-xs font-bold text-slate-400"
                    >
        ...
        <PaymentModal
            ...
            :is-checking-voucher="isCheckingVoucher"
            :voucher-preview="voucherPreview"
                ...
                >
                    ...
                    <div class="mt-5 space-y-3">
                        ...
                        >
                            ...
                            <option :value="customCancelReasonValue">
                                Khác
                            </option>
                        </select>
                        <textarea
                        ...
                        <p class="text-[11px] leading-5 text-slate-500">
                            ...
                            quản lý duyệt và ghi nhận tổn thất nếu được duyệt.
                        </p>
                    </div>
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <button
                            ...
                            :disabled="
                                effectiveCancelItemReason.length < 3 ||
                                isCancellingItem
                            "
