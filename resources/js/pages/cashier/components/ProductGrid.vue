    ...
    <div class="flex flex-col gap-4">
        ...
        >
            ...
            >
                <button
                    ...
                    class="rounded-xl px-3.5 py-2 text-xs font-bold transition-all duration-200 active:scale-95"
                    :class="
        ...
        >
            <div
                ...
                "
                class="motion-card group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-slate-800 dark:bg-slate-900"
                :class="{
