                ...
                <div class="space-y-4 p-5">
                    <template v-if="mode === 'move'">
                        <p class="text-xs leading-5 text-slate-500">
                            Chọn một bàn đang trống để chuyển toàn bộ đơn hiện
                            tại sang.
                        </p>
                        <div
                        ...
                        >
                            <button
                                ...
                                "
                                @click="
                                    emit('update:selectedTableId', table.id)
                                "
                            >
                                <span
                    ...
                    <template v-else>
                        <p class="text-xs leading-5 text-slate-500">
                            Chọn bàn đích để chuyển toàn bộ món của bàn hiện tại
                            vào cùng một đơn. Đơn nguồn sẽ được đóng lại sau khi
                            gộp.
                        </p>
                        <div
