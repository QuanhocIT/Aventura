...
<template>
    ...
    <div class="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        ...
        <!-- Featured posts -->
        <div v-if="featuredPosts.length && !activeCategory" class="mb-12">
            <h2 class="mb-5 text-lg font-semibold">Bài nổi bật</h2>
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <NewsCard v-for="post in featuredPosts" :key="post.id" v-bind="post" />
            </div>
        </div>
