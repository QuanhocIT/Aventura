...
<template>
    ...
    <div class="flex flex-col gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <Card class="rounded-2xl border-slate-200 dark:border-slate-800 overflow-hidden">
            <!-- Filter Bar -->
            <div class="p-4 border-b bg-slate-50/50 dark:bg-slate-900/20 flex flex-col gap-3">
                ...
                <div class="flex items-center gap-2">
                    <div class="relative flex-1 max-w-sm">
                        ...
                        <input
                            ...
                            class="w-full pl-7 pr-3 py-1.5 text-xs rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-400/40 focus:border-indigo-400"
                        />
                    </div>
                    <span class="text-[10px] text-slate-400 font-bold shrink-0">
                        {{ filteredFeedbacks.length }} / {{ stats.total }} phản hồi
                    </span>
                </div>
            </div>
                    ...
                    <div class="flex-1 flex gap-4 items-start">
                        ...
                        <div class="flex-grow flex flex-col gap-1">
                            ...
                            <p class="text-xs text-slate-600 dark:text-slate-350 leading-relaxed mt-1">
                                ...
                                <span
                                    v-if="fb.sentiment"
                                    class="ml-1.5 inline-flex items-center rounded-full px-1.5 py-0.5 text-[9px] font-bold align-middle"
                                    :class="sentimentConfig[fb.sentiment]?.class"
                                >
