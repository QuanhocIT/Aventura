            ...
            <div class="relative z-10">
                <div class="mb-2 flex items-center gap-2">
                    <Link
                        ...
                        class="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-500/10 px-2.5 py-0.5 text-[10px] font-medium text-emerald-700 transition-colors hover:bg-emerald-500/20 dark:border-white/10 dark:bg-white/5 dark:text-emerald-300 dark:hover:bg-white/10 dark:hover:text-white"
                    >
