...
.recipe-stat-card:hover {
    border-color: var(--recipe-stat-color);
    transform: translateY(-1px);
}

.recipe-stat-card--success {
    --recipe-stat-color: #059669;
    border-color: #a7f3d0;
    background: #f0fdf4;
}

.recipe-stat-card--warning {
    --recipe-stat-color: #d97706;
    border-color: #fde68a;
    background: #fffbeb;
}

.recipe-stat-card--accent {
    --recipe-stat-color: #4f46e5;
    border-color: #c7d2fe;
    background: #f5f3ff;
}
...
.recipe-stat-card--success .recipe-stat-icon {
    background: #dcfce7;
    color: #059669;
}

.recipe-stat-card--warning .recipe-stat-icon {
    background: #fef3c7;
    color: #d97706;
}

.recipe-stat-card--accent .recipe-stat-icon {
    background: #e0e7ff;
    color: #4f46e5;
}
...
.recipe-action-btn:hover .recipe-action-icon {
    color: #4338ca;
}
