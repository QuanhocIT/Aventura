            ...
            <div class="grid gap-6 lg:grid-cols-5">
                ...
                <Card class="lg:col-span-2 shadow-sm">
                    <CardHeader class="border-b border-border pb-3">
                        ...
                        <CardDescription class="text-[11px]">Cập nhật tồn kho và giá vốn bình quân tự động.</CardDescription>
                    </CardHeader>
                    <CardContent class="pt-5">
                        <form @submit.prevent="submitPurchase" class="space-y-4">
                            ...
                            <div class="flex items-start gap-2 text-[11px] text-muted-foreground">
                                ...
                                Nhập hàng sẽ cập nhật giá vốn bình quân (weighted average) tự động để tính COGS chính xác.
                            </div>

                            <Button type="submit" class="w-full bg-indigo-600 text-white hover:bg-indigo-700"
                                :disabled="purchaseForm.processing">
                                <ArrowDownToLine class="size-4 mr-2" />
                                {{ purchaseForm.processing ? 'Đang lưu...' : 'Xác nhận nhập hàng' }}
                            </Button>
                        </form>
                    </CardContent>
                </Card>
