...
<template>
    ...
    <div class="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 sm:p-6">
        <!-- Header -->
        <section
            class="flex flex-col gap-4 rounded-2xl border border-border/70 bg-card p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:p-6"
        >
            <div class="flex items-start gap-4">
                <div
                    class="flex size-12 shrink-0 items-center justify-center rounded-xl border border-border/70 bg-primary/10 text-primary"
                >
                ...
                <div>
                    ...
                    >
                        Gửi đề nghị bổ sung nguyên liệu cho chi nhánh. Chủ doanh
                        nghiệp sẽ xem xét nguồn cấp và điều phối phiếu điều
                        chuyển.
                    </p>
                </div>
            </div>
            <div
                class="rounded-xl border border-amber-500/20 bg-amber-500/10 px-4 py-3 text-xs text-amber-600 lg:max-w-xs dark:text-amber-400"
            >
                <div class="flex items-start gap-2">
                    <Info class="mt-0.5 size-4 shrink-0" />
                    <p>
                        Quản lý không tự chọn kho nguồn và không được tự trừ tồn
                        kho.
                    </p>
                </div>
            </div>
        ...
        <section class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            >
                ...
                <p class="mt-1 text-xs text-muted-foreground">
                    Đang chờ Chủ doanh nghiệp phản hồi
                </p>
            </div>
            <div
                class="rounded-xl border border-border/70 bg-card p-4 shadow-sm"
        ...
        <!-- Main Workspace -->
        <section
            class="grid items-start gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(300px,0.9fr)]"
        >
            <!-- Form Card -->
            <article
            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-muted-foreground">
                            Thông tin này sẽ được gửi trực tiếp đến hàng chờ của
                            Chủ doanh nghiệp.
                        </p>
                    </div>
                </div>
                ...
                <form class="mt-5 space-y-4" @submit.prevent="submitRequest">
                    <div
                        class="rounded-xl border border-border/70 bg-muted/40 p-3.5"
                    >
                        ...
                        <p class="mt-1 text-xs text-muted-foreground">
                            Chi nhánh được xác định theo tài khoản Quản lý.
                        </p>
                        <p
                            v-if="!hasAssignedBranch"
                            class="mt-2 text-xs font-semibold text-rose-500"
                        >
                            Tài khoản chưa được gán chi nhánh nên chưa thể gửi
                            yêu cầu.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <p class="text-[11px] text-muted-foreground">
                                Khẩn cấp sẽ được đưa lên đầu hàng chờ Chủ doanh
                                nghiệp.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        />
                        <p class="text-[11px] text-muted-foreground">
                            Ghi rõ nguyên nhân để Chủ doanh nghiệp quyết định số
                            lượng và nguồn cấp phù hợp.
                        </p>
                        <p
                    ...
                    <div
                        class="flex flex-col-reverse gap-2 border-t border-border/70 pt-4 sm:flex-row sm:items-center sm:justify-between"
                    >
                        <p class="text-xs text-muted-foreground">
                            Gửi yêu cầu không làm thay đổi tồn kho.
                        </p>
                        <Button
                            type="submit"
                            :disabled="
            ...
            <aside class="space-y-5">
                ...
                >
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        >
                            <div
                                class="flex size-7 shrink-0 items-center justify-center rounded-full border border-primary/30 bg-primary/10 text-xs font-bold text-primary"
                            >
                                {{ index + 1 }}
                            </div>
                            <div>
                                ...
                                >
                                    Quản lý nêu rõ nguyên nhân, số lượng và mức
                                    độ ưu tiên.
                                </p>
                                <p
                                    v-else-if="index === 1"
                                    class="mt-0.5 text-xs text-muted-foreground"
                                >
                                    Chủ doanh nghiệp quyết định có điều chuyển
                                    hay từ chối.
                                </p>
                                <p
                                    v-else-if="index === 2"
                                    class="mt-0.5 text-xs text-muted-foreground"
                                >
                                    Kho được chọn thực hiện xuất, bàn giao và
                                    cập nhật chứng từ.
                                </p>
                                <p
                                    v-else
                                    class="mt-0.5 text-xs text-muted-foreground"
                                >
                                    Phiếu chỉ hoàn tất sau khi giao nhận được
                                    ghi nhận.
                                </p>
                            </div>
                        </div>
                ...
                >
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p
                                class="mt-1 text-xs leading-5 text-amber-800 dark:text-amber-200"
                            >
                                Không tạo yêu cầu trùng khi phiếu cũ vẫn đang xử
                                lý. Nếu tình hình thay đổi, hãy hủy phiếu đang
                                chờ và tạo phiếu mới với lý do cập nhật.
                            </p>
                        </div>
                    </div>
                </article>
        ...
        >
            ...
            >
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-muted-foreground">
                        Chỉ hiển thị các yêu cầu do tài khoản của bạn tạo.
                    </p>
                </div>
                <span
                    class="rounded-full border border-border/70 bg-muted/40 px-3 py-1 text-xs font-semibold text-muted-foreground"
            ...
            <div v-if="visibleRequests.length" class="mt-4 space-y-3">
                ...
                >
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <span
                                    ...
                                    class="rounded-full border border-orange-500/20 bg-orange-500/10 px-2 py-0.5 text-[10px] font-bold text-orange-600 dark:text-orange-400"
                                    >Khẩn cấp</span
                                >
                                <span
                                    class="inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[10px] font-bold"
                                    :class="
                                        statusInfo(request.status).className
                                    "
                                >
                                    <component
                                        :is="statusInfo(request.status).icon"
                                        class="size-3"
                                    />
                            ...
                            <p
                                class="mt-3 rounded-lg bg-muted/40 px-3 py-2 text-xs leading-5 text-muted-foreground"
                            >
                                <b class="text-foreground">Lý do:</b>
                                {{ request.reason }}
                            </p>
                            <p
                                v-if="request.owner_note"
                                class="mt-2 text-xs font-medium text-primary"
                            >
                                <b>Phản hồi điều phối:</b>
                                {{ request.owner_note }}
                            </p>
                            <p
                                v-if="request.reject_reason"
                                class="mt-2 text-xs font-medium text-rose-500"
                            >
                                <b>Lý do từ chối:</b>
                                {{ request.reject_reason }}
                            </p>
                            <p
                                v-if="request.cancel_reason"
                                class="mt-2 text-xs font-medium text-rose-500"
                            >
                                <b>Lý do hủy:</b> {{ request.cancel_reason }}
                            </p>
                        </div>
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            class="shrink-0 gap-1.5 text-rose-600 hover:bg-rose-50 hover:text-rose-700 dark:text-rose-400 dark:hover:bg-rose-950/30"
                    ...
                    <div
                        ...
                        "
                        class="mt-4 flex items-center gap-1 border-t border-border/70 pt-4"
                    >
                        <template
                            v-for="(step, index) in workflowSteps"
                            :key="step"
                        >
                            <div
                                class="flex min-w-0 items-center gap-1 text-[10px] font-bold"
                                :class="
                                    index <= progressIndex(request.status)
                                        ? 'text-primary'
                            ...
                            <span
                                ...
                                class="h-px min-w-2 flex-1 bg-border/70"
                                :class="
                                    index < progressIndex(request.status)
                                        ? 'bg-primary/50'
                                        : ''
            ...
            <div
                v-else
                class="mt-4 rounded-xl border border-dashed border-border/70 bg-muted/20 p-10 text-center"
            >
                ...
                <p class="mt-1 text-xs text-muted-foreground">
                    Tạo yêu cầu đầu tiên khi chi nhánh phát sinh nhu cầu bổ sung
                    đột xuất.
                </p>
            </div>

            <div
                v-if="props.transfers.length > 10"
            ...
            >
                <Button
                    ...
                    >{{
                        showAll ? 'Thu gọn danh sách' : 'Xem tất cả yêu cầu'
                    }}</Button
                >
            </div>
        </section>
    ...
    <Teleport to="body">
        ...
        >
            <div
                class="w-full max-w-md rounded-2xl border border-border/70 bg-background p-5 shadow-2xl"
            >
                <div class="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-muted-foreground">
                            {{ cancelling.ingredient }} ·
                            {{ formatNumber(cancelling.quantity_requested) }}
                            {{ cancelling.unit }}
                        </p>
                    </div>
                    <Button
                ...
                <form class="mt-5 space-y-4" @submit.prevent="submitCancel">
                    <div class="flex flex-col gap-1.5">
                        ...
                        <textarea
                            ...
                            maxlength="500"
                            rows="4"
                            class="rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground focus:ring-2 focus:ring-primary"
                            placeholder="Ví dụ: chi nhánh đã tự cân đối được tồn trong ngày..."
                        />
                        <p
                            v-if="cancelForm.errors.cancel_reason"
                            class="text-xs text-rose-500"
                        >
