...
<template>
    <div
        class="flex min-h-screen flex-col bg-slate-950 pb-24 font-sans text-slate-100 select-none md:pb-0 md:pl-0"
    >
        ...
        <!-- Main Body Wrapper -->
        <main class="mx-auto w-full max-w-4xl flex-1 space-y-6 p-4">
            <div
                v-if="loading"
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        >
                            ...
                            <p class="mt-2 text-2xl font-bold text-white">
                                {{ formatCurrency(summary.estimated_earnings) }}
                            </p>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p
                                            v-if="metric.commission_earned > 0"
                        ...
                        >
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div class="space-y-1">
                                    <label
                                        class="text-xs font-medium text-slate-400"
                                        >Ca trực muốn đổi của đồng nghiệp</label
                                    >
                                    <select
                                        v-model="
