...
<template>
    ...
    <div class="flex flex-col gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <Card class="shadow-sm overflow-hidden">
            <!-- Search bar header -->
            <div class="p-4 bg-slate-50/50 dark:bg-slate-900/30 border-b flex items-center gap-2">
            ...
            <CardContent class="p-0">
                <div v-if="customers.length === 0" class="flex flex-col items-center gap-3 py-20 text-center text-muted-foreground">
                    ...
                    <table class="w-full text-xs text-left border-collapse">
                        <thead>
                            <tr class="bg-slate-100 dark:bg-slate-950 border-b text-[10px] uppercase font-bold tracking-wider text-slate-500">
                                ...
                                <th class="p-3.5">Điểm tích lũy</th>
                                <th class="p-3.5">Đơn cuối lúc</th>
                                <th class="p-3.5">Ngày tham gia</th>
                                <th class="p-3.5 text-right">Thao tác</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <tr v-for="c in customers" :key="c.id" class="hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors">
                                ...
                                <td class="p-3.5 font-bold font-mono text-sm text-indigo-600 dark:text-indigo-400">{{ c.loyalty_points }} pt</td>
                                <td class="p-3.5 font-mono text-slate-400">{{ c.last_order_at }}</td>
