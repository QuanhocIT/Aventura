    ...
    <div class="mx-auto flex max-w-7xl flex-col gap-6 p-6">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-sm font-semibold"
                        >Phân bố hạng thành viên</CardTitle
                    >
                </CardHeader>
                <CardContent class="space-y-3">
                    ...
                    >
                        ...
                        <Link href="/loyalty/settings" class="underline"
                            >Thiết lập ngay</Link
                        >
                    </div>
                </CardContent>
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="text-sm font-semibold"
                        >Phần thưởng ({{ rewards.length }})</CardTitle
                    >
                </CardHeader>
            ...
            <Card class="lg:col-span-1">
                ...
                <CardContent class="max-h-64 space-y-2 overflow-y-auto">
                    <div
                        v-for="tx in metrics.recentTransactions.slice(0, 10)"
                        :key="tx.id"
                        class="flex items-center justify-between border-b pb-2 text-xs last:border-0"
                    >
                        <div>
                            <span
                                :class="[
