    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6 p-6">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Cấu hình quy tắc tích điểm, quy đổi, và hết
                    hạn.</CardDescription
                >
            </CardHeader>
            <CardContent>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="grid gap-1.5">
                            ...
                            <span class="text-xs text-muted-foreground"
                                >Ví dụ: 0.0001 = 1 điểm mỗi 10,000 VND</span
                            >
                        </div>
                        <div class="grid gap-1.5">
                            ...
                            />
                            <span class="text-xs text-muted-foreground"
                                >Khi quy đổi điểm thành tiền giảm giá</span
                            >
                        </div>
                        <div class="grid gap-1.5">
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            >
                                <input
                                    type="checkbox"
                                    v-model="programForm.enable_qr_card"
                                    class="rounded"
                                />
                                <span class="text-sm font-medium"
                                    >Bật thẻ thành viên QR</span
                                >
                            </label>
                        </div>
                    </div>
        ...
        <Card>
            <CardHeader class="flex flex-row items-center justify-between">
                <div>
                    ...
                    <CardDescription
                        >Thiết lập các bậc hạng dựa trên chi tiêu tích
                        lũy.</CardDescription
                    >
                </div>
            ...
            <CardContent>
                ...
                >
                    Chưa có hạng thành viên nào. Nhấn "Thêm hạng" để bắt đầu.
                </p>
            </CardContent>
        </Card>
    </div>
