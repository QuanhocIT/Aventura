    ...
    <div class="min-h-dvh grid-cols-1 flex flex-col lg:grid lg:grid-cols-[1.1fr_2fr]">
        ...
        <div class="relative flex min-h-dvh flex-col overflow-hidden bg-gradient-to-b from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 px-6 py-10 sm:px-10 md:px-12">
            ...
            <div class="flex flex-1 flex-col justify-start pt-6 sm:pt-8 relative z-10">
                <div class="animate-in fade-in slide-in-from-bottom-6 duration-500 fill-mode-both w-full max-w-md mx-auto backdrop-blur-2xl bg-white/75 dark:bg-zinc-950/65 border border-white/40 dark:border-white/[0.08] p-8 sm:p-10 rounded-3xl shadow-[0_24px_64px_rgba(0,0,0,0.06),0_8px_20px_rgba(0,0,0,0.03)] dark:shadow-[0_24px_64px_rgba(0,0,0,0.35)]">

                    <div class="mb-4 inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-3.5 py-1 text-xs font-bold text-primary">
                        <span class="h-1.5 w-1.5 animate-pulse rounded-full bg-primary/80" />
                        Miễn phí 14 ngày
                    </div>
                    <h1 class="bg-gradient-to-r from-zinc-950 via-zinc-800 to-primary dark:from-white dark:via-zinc-200 dark:to-primary bg-clip-text text-3xl font-black tracking-tight text-transparent leading-none">Tạo tài khoản doanh nghiệp</h1>
                        ...
                        <div class="space-y-3 p-3.5 rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/30">
                            <div class="flex items-center space-x-2.5">
                                <input
                                    ...
                                    id="has_referral"
                                    v-model="hasReferral"
                                    class="h-4 w-4 rounded border-zinc-300 text-primary focus:ring-primary focus:ring-offset-0 cursor-pointer"
                                />
            ...
            <p class="text-center text-sm text-muted-foreground mt-6 relative z-10">
                Đã có tài khoản?
                <TextLink :href="login()" :tabindex="8" class="font-bold text-primary underline underline-offset-4 hover:text-primary/80 transition-colors">
                    Đăng nhập
                </TextLink>
            </p>
        </div>
        ...
        <div class="relative hidden flex-col overflow-hidden border-l border-zinc-900 bg-zinc-950 px-12 py-10 lg:flex lg:min-h-dvh justify-between">
            ...
            <div class="pointer-events-none absolute top-1/4 left-1/3 h-[500px] w-[500px] rounded-full bg-primary/[0.12] blur-[80px] z-0" />
            ...
            <div class="relative z-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-1 rounded-xl border border-white/10 bg-white/5 p-1 text-xs shrink-0 self-start sm:self-auto backdrop-blur-md">
                    ...
                    >
                        Năm
                        <span class="text-[9px] font-bold bg-primary text-white px-1.5 py-0.5 rounded-full shadow-xs">-{{ maxDiscountPercent }}%</span>
                    </button>
                </div>
            </div>
                ...
                <div class="animate-in fade-in slide-in-from-bottom-4 duration-700 fill-mode-both w-full">
                    ...
                    <div class="mt-5 rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-md px-5 py-4 transition-all duration-300 shadow-md">
                        <p class="text-xs text-zinc-400 flex flex-wrap items-center gap-1.5 leading-relaxed">
                            <span class="inline-flex h-2 w-2 shrink-0 items-center justify-center rounded-full bg-primary animate-pulse" />
