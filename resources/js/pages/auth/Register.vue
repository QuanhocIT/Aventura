...
<template>
    ...
    >
        ...
        >
            ...
            />
            <div
                class="pointer-events-none absolute -bottom-20 -left-20 h-[400px] w-[400px] animate-pulse rounded-full bg-emerald-50/15 blur-[120px] duration-[8s]"
            />
            <div
            ...
            >
                ...
                >
                    <div
                        class="mb-4 inline-flex items-center gap-1.5 rounded-full border border-emerald-500/15 bg-emerald-500/[0.03] px-3.5 py-1 text-xs font-bold text-emerald-600 dark:text-emerald-400"
                    >
                        <span
                            class="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400/80"
                        />
                        Miễn phí 14 ngày
                    </div>
                    <h1
        ...
        >
            ...
            <div class="relative z-10">
                ...
                <p class="mt-2 max-w-md text-sm leading-relaxed text-zinc-500">
                    ...
                    <span class="font-black text-zinc-300">Free</span> — hoàn
                    toàn không mất gì cả.
                </p>
            </div>
