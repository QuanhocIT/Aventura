        ...
        >
            ...
            >
                ...
                <div class="space-y-4 p-6">
                    <div
                        class="rounded-2xl border border-indigo-100 bg-indigo-50 p-4 text-center"
                    >
                        <p
                        ...
                        <p class="mt-1 text-xl font-black text-indigo-700">
        ...
        <div v-else>
            ...
            <div class="relative">
                ...
                >
                    ...
                    />
                    <div
                        class="absolute -top-16 -left-16 h-56 w-56 rounded-full"
                        style="
                    ...
                    ></div>
                    <div
                        class="absolute -right-8 -bottom-8 h-44 w-44 rounded-full"
                        style="
                            background: radial-gradient(
                                circle,
                ...
                <div class="absolute right-0 bottom-0 left-0 px-4 pb-5">
                    <div class="mx-auto max-w-2xl">
                        <div class="flex items-end gap-3">
                            <div class="shrink-0">
                                <div
                                    v-if="restaurant.logo_url"
                                    class="h-14 w-14 overflow-hidden rounded-xl shadow-xl ring-2 ring-white/20 sm:h-18 sm:w-18"
                                >
                                    <img
                            ...
                            <div class="min-w-0 flex-1 pb-0.5">
                                ...
                                <p
                                    ...
                                    class="mt-0.5 line-clamp-1 text-xs text-white/60"
                                >
                                    {{ config.description }}
                                </p>
                                <div
            ...
            <div class="mx-auto max-w-2xl px-4">
                <div
                    class="flex items-center gap-2 overflow-x-auto pt-3 pb-1"
                    style="scrollbar-width: none"
                >
                    <div
                        v-if="config.enable_delivery"
                        class="flex shrink-0 items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-semibold"
                        style="
                            background: #fff;
                            border-color: #e5e7eb;
                            color: #374151;
                        "
                    >
                        <Truck class="size-3.5 text-indigo-500" /> Giao hàng tận
                        nơi
                    </div>
                    <div
                    ...
                    <div
                        v-if="config.min_order_amount > 0"
                        class="flex shrink-0 items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-semibold"
                        style="
                            background: #fff;
                            border-color: #e5e7eb;
                        ...
                        "
                    >
                        <Star class="size-3.5 text-yellow-400" /> Tối thiểu
                        {{ config.min_order_amount.toLocaleString() }}đ
                    </div>
                </div>
            </div>
            ...
            <div class="sticky top-0 z-30 mx-auto mt-3 max-w-2xl">
                <div
                    class="mx-4 overflow-hidden rounded-2xl"
                    style="
                        background: #fff;
                ...
                >
                    <div
                        class="flex gap-1 overflow-x-auto p-1.5"
                        style="scrollbar-width: none"
                    >
                        <button
            ...
            <!-- PRODUCT GRID -->
            <main class="mx-auto max-w-2xl px-4 pt-5 pb-36">
                <!-- "Tất cả" view -->
                    ...
                    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3">
                        ...
                        >
                            <div
                                ...
                                style="background: #f8f9fa; aspect-ratio: 4/3"
                            >
                                <img
                                    v-if="p.image_url"
                                    :src="p.image_url"
                                ...
                                <div
                                    v-if="cart[p.id]"
                                    class="absolute top-2 right-2 flex h-6 w-6 items-center justify-center rounded-full text-xs font-black text-white"
                                    style="
                                        background: linear-gradient(
                                            135deg,
                                            #6366f1,
                            ...
                            <div class="flex flex-1 flex-col p-3">
                                <p
                                    class="line-clamp-2 text-sm leading-snug font-bold text-slate-800"
                                >
                                    {{ p.name }}
                                </p>
                                <p
                                    v-if="p.description"
                                    class="mt-0.5 line-clamp-2 text-[11px] leading-relaxed text-slate-400"
                                >
                                    {{ p.description }}
                                </p>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span
                                            class="w-5 text-center text-sm font-black text-slate-800"
                                            >{{ cart[p.id].quantity }}</span
                                        >
                                        <button
                                            @click="addToCart(p)"
                                            class="flex h-7 w-7 items-center justify-center rounded-full text-white transition-all active:scale-90"
                                            style="
                                                background: linear-gradient(
                                                    135deg,
                                                    #6366f1,
                ...
                >
                    <div class="mb-4 flex items-center gap-2">
                        ...
                        <span class="ml-auto text-xs text-slate-400"
                            >{{ (products[cat.id] ?? []).length }} món</span
                        >
                    </div>
                    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3">
                        <div
            ...
            >
                <div
                    v-if="cartCount > 0"
                    class="fixed right-0 bottom-6 left-0 z-50 flex justify-center px-4"
                >
                    <button
                        @click="showCart = true"
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div
                                class="relative flex h-9 w-9 items-center justify-center rounded-xl bg-white/20"
                            >
                                <ShoppingCart class="size-5" />
                                <span
                                    class="absolute -top-1.5 -right-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-white text-xs font-black"
                                    style="color: #6366f1"
                                    >{{ cartCount }}</span
                                >
                            </div>
