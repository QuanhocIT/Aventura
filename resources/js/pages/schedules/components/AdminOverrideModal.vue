...
<template>
    <FormModal
        ...
        description="Ghi nhận thông tin chấm công hộ hoặc báo vắng trực tiếp dưới danh nghĩa quản trị viên."
        :processing="processingOverride"
        submit-label="Xác nhận ghi nhận"
        processing-label="Đang cập nhật..."
        @submit="submitAdminOverride"
    >
