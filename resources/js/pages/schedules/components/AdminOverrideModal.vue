                ...
                <CardContent class="flex-1 overflow-y-auto space-y-4 pt-4">
                    ...
                    >
                        <Label
                            class="text-xs font-bold text-slate-800 dark:text-slate-200"
                        >
                            Nhân viên vào ca đúng giờ so với thời gian gửi yêu
                            cầu xin xác nhận check-in không?
                        </Label>
                        ...
                        <div
                            v-if="!isOnTime"
                            class="animate-in space-y-1.5 pt-2 duration-150 fade-in"
                        >
                            <Label
                                for="actual-time-input"
                            ...
                            <p class="text-[10px] text-muted-foreground">
                                Nhập giờ nhân viên có mặt làm việc thực tế (Ví
                                dụ: 06:15).
                            </p>
                        </div>
                    </div>
