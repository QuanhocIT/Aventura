            ...
            >
                ...
                >
                    <div>
                        ...
                        <CardDescription
                            >Gửi yêu cầu trao đổi ca làm việc của bạn cho một
                            đồng nghiệp trong tuần này.</CardDescription
                        >
                    </div>
                    <button
                        @click="emit('close')"
                ...
                <CardContent class="space-y-4 pt-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            Không có ca trực nào khác của đồng nghiệp trong tuần
                            này để đổi.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        />
                        <p>
                            <strong>Quy trình phê duyệt:</strong> Sau khi gửi,
                            đồng nghiệp nhận được yêu cầu phải nhấn "Đồng ý",
                            sau đó Quản lý/Owner duyệt thì ca đổi mới chính thức
                            có hiệu lực.
                        </p>
                    </div>
