...
export const FEATURE_LABELS: Record<
    FeatureKey,
    { label: string; required_plan: string }
> = {
    kitchen_display: {
        label: 'Màn hình Bếp (Kitchen Display)',
    ...
    hr_full: {
        label: 'Quản lý Lương & Nhân sự',
        required_plan: 'Chuyên Nghiệp',
    },
    advanced_analytics: {
        label: 'Phân tích & Báo cáo Nâng cao',
        required_plan: 'Chuyên Nghiệp',
    },
    ...
    email_reports: {
        label: 'Email Báo cáo Tự động',
        required_plan: 'Chuyên Nghiệp',
    },
    ai_advisor: {
        label: 'AI Tư vấn Chiến lược',
        required_plan: 'Chuyên Nghiệp',
    },
    supplier_portal: {
